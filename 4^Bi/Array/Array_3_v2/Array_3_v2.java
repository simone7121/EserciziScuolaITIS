...
Algoritmo:  Chiedere all'utente di inserire un numero finito di elementi, 
            ...
            soltanto dei multipli di 3 e di 5 (INSIEME), ed eseguirne il 
            relativo output.
...
class Array_3_v2{
    public static void main(String[] args) {
        ...
        System.out.println("\nSomma numeri multipli di 3 e di 5 array\n");
        ...
        for ( int j=0; j < arrayNumeri.length; j++ ){
            ...
            if ( arrayNumeri[j]%3 == 0 && arrayNumeri[j]%5 == 0 ) {
        ...
        System.out.print("La somma dei numeri multipli di 3 e di 5 risultera': " + somma);
